...
def compute_pw_dist_sqr(x: Tensor, y: Optional[Tensor] = None, final_device: str | device = "cpu") -> Tensor:
    ...
    gram_matrix = compute_gram_matrix(flattened_x, flattened_y).to(final_device)
