...
class DDPMDynamic(nn.Module):
    ...
    def get_x0_from_x0(self, xt: Tensor, x0: Tensor, t: Tensor) -> Tensor:
        return x0
    ...
    def get_eps_from_eps(self, xt: Tensor, eps: Tensor, t: Tensor) -> Tensor:
        return eps
    ...
    def get_score_from_score(self, xt: Tensor, score: Tensor, t: Tensor) -> Tensor:
        return score
